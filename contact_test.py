...
class TestContact(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.new_contact = Contact("James","Muriuki","0711345678","james@ms.com")
  ...
  def test_init(self):
    ...
    self.assertEqual(self.new_contact.phone_number,"0711345678")
  ...
  def test_save_multiple_contact(self):
    ...
    self.new_contact.save_contact()
    test_contact = Contact("Test","user","0700111222","test@user.com")
